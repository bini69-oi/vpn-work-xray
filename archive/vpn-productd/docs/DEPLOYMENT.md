# VPN Product deployment

> Объединяет материалы бывшего `STAGING_DEPLOY.md` и операционные заметки. Single-server, systemd.

For incident response and fast troubleshooting, see [INCIDENT_RUNBOOK.md](INCIDENT_RUNBOOK.md).
...
using [DR_RUNBOOK.md](DR_RUNBOOK.md).
